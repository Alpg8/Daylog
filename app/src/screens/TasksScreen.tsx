...
const local = StyleSheet.create({
  ...
  bottomTabDoneCheck: { position: "absolute", bottom: -2, right: -2, fontSize: 11, fontWeight: "800", color: "#22c55e", backgroundColor: "transparent", borderRadius: 6, paddingHorizontal: 1 },
