        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="rounded-md border border-blue-200 bg-blue-50 px-3 py-2 text-xs text-blue-900">
              Mobil uygulamaya giriş yapacak hesaplar için rolü <strong>"Sürücü"</strong> seçin.
              Giriş bilgileri: kullanıcının <strong>e-posta</strong> ve <strong>şifresi</strong>.
              Şifre en az 8 karakter olmalı, en az bir büyük harf ve bir rakam içermelidir.
            </div>
            <DialogFooter>
