    ...
    <div className="min-h-screen bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800 px-4 py-8">
      ...
      <div className="glass-strong glass-highlight relative w-full rounded-3xl p-8">
        ...
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl font-bold tracking-tight text-white">Daylog Web Panel</h1>
          <p className="mt-1 text-sm text-white/40">Admin ve Operasyon Girisi</p>
        </div>
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <p className="text-center text-xs text-white/50">
              Sofor uygulamasi icin <Link href="/mobile-login" className="text-blue-300 underline">mobil giris ekranini</Link> kullanin.
            </p>
      ...
      <div className="hidden rounded-3xl border border-white/10 bg-white/5 p-6 text-white md:block">
        <p className="text-xs uppercase tracking-[0.2em] text-white/60">Web Management</p>
